 ...
 * @Last Modified time: 2018-04-04 18:15:41
 * @For test
 */
...
void mytestsift() {
	Mat img1 = imread("/media/cwh1001/Workspace/CUDA_projects/material_fusion/data/500X 500PIC/sam00000.jpg", IMREAD_GRAYSCALE);
